...
<template>
  <Transition name="fade">
    <div v-if="visible" class="p-4 rounded-xl bg-surface-container-lowest border border-outline-variant/30 flex items-center justify-between group hover:border-accent/50 transition-all duration-300">
